...
function preload(){
  trex_running = loadAnimation("trex1-1.png","trex2.png","trex3-1.png");
  trex_collided = loadAnimation("trex_collided(3).png");
...
function setup() {
 ...
 console.log(message)
  ...
  gameOver = createSprite(width/2,height-250,width,125);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(width/2,height-200,width,125);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width/2,height-10,width,200);
